...
- Part 2. Listening - Monologue (Độc thoại): Listen and decide if each statement is True (T) or False (F) (5 câu - từ câu 6 đến 10). Chỉ dùng A. True và B. False.
- Part 3. Choose the best answer A, B or C to complete the sentences (12 câu - từ câu 11 đến 22).
- Part 4. Read the passage and choose the correct word A, B or C for each blank (5 câu - từ câu 23 đến 27).
...
Tất cả câu trắc nghiệm đều chỉ có TỐI ĐA 3 đáp án: A, B, C. Đánh số câu liên tục từ 1 đến 36. Câu Writing (Part 8) không đánh số trắc nghiệm. KHÔNG tạo đáp án D.`;
    metaData = `MA TRẬN BẮT BUỘC: Nghe 25% (2.5 điểm), Đọc 25% (2.5 điểm), Ngôn ngữ 30% (3.0 điểm), Viết 20% (1.0 điểm viết lại/sắp xếp + 1.0 điểm viết đoạn văn = 2.0 điểm). Tổng điểm bài kiểm tra trên giấy là 10.0 điểm (36 câu trắc nghiệm x 0.25 điểm + 1 câu viết tự luận x 1.0 điểm). Mức độ: Biết 40%, Hiểu 30%, Vận dụng 30%.`;
  } else {
    // Final term
    totalQuestions = 37;
