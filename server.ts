...
Tất cả 20 câu trắc nghiệm đều chỉ có TỐI ĐA 3 đáp án: A, B, C. Đánh số câu liên tục từ 1 đến 20. KHÔNG tạo đáp án D.`;
    ...
    titleString = `ĐỀ KIỂM TRA ${term?.toUpperCase() || "GIỮA HỌC KÌ I"} - TIẾNG ANH LỚP ${grade}`;
    structureGuideline = `CẤU TRÚC ĐỀ BẮT BUỘC (8 Phần):
- Part 1. Listening 1 (5 câu - 1.25đ): True/False hoặc A/B/C.
- Part 2. Listening 2 (5 câu - 1.25đ): Chọn A, B hoặc C.
- Part 3. Language Focus (12 câu - 3đ): Chọn A, B hoặc C.
- Part 4. Reading 1 (5 câu - 1.25đ): Điền từ vào chỗ trống, chọn A, B hoặc C. (Đoạn 150-180 từ)
- Part 5. Reading 2 (5 câu - 1.25đ): Đọc hiểu chọn A, B hoặc C. (Đoạn 150-180 từ)
- Part 6. Sentence transformation / closest meaning (2 câu - 0.5đ): Chọn A, B hoặc C.
- Part 7. Reorder words/phrases (2 câu - 0.5đ): Chọn A, B hoặc C.
- Part 8. Writing (1 câu - 1đ): Viết đoạn văn 80-100 từ có gợi ý.

Tất cả câu trắc nghiệm đều chỉ có TỐI ĐA 3 đáp án: A, B, C. Đánh số câu liên tục từ 1 đến 36. Câu Writing là phần cuối, không đánh số trắc nghiệm.
KHÔNG tạo đáp án D.`;
